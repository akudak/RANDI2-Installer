...
import model.enumerations.Language;
...
public class LanguagePanel extends MainPanel {
	...
	public LanguagePanel(final Main main) {
		super(main);
		JLabel lger = new JLabel("Bitte wählen Sie eine Sprache aus.");
		...
		ImageIcon ger = new ImageIcon(
				ClassLoader.getSystemResource("files/ger.png"));
		...
		ImageIcon us = new ImageIcon(
				ClassLoader.getSystemResource("files/us.png"));
