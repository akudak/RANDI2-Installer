...
public class Statusbar extends JPanel {
	...
	public void init() {
		...
		iconGreen = new ImageIcon(
				ClassLoader.getSystemResource("files/gruen_30x30.png"));
		iconYellow = new ImageIcon(
				ClassLoader.getSystemResource("files/gelb_30x30.png"));
		iconRed = new ImageIcon(
				ClassLoader.getSystemResource("files/rot_30x30.png"));
		iconGreenG = new ImageIcon(
				ClassLoader.getSystemResource("files/gruen.png"));
		iconYellowG = new ImageIcon(
				ClassLoader.getSystemResource("files/gelb.png"));
		iconRedG = new ImageIcon(ClassLoader.getSystemResource("files/rot.png"));
